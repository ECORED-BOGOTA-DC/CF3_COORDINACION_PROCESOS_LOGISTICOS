  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mb-4
      .col-lg-4.col-sm-8.mb-lg-0.mb-4(data-aos="fade-right")
        figure.mb-4
          img(src='@/assets/curso/img20.svg', style="width: 450px; margin: auto;" alt="Imagen decorativa")
        .h5 Servicio al cliente
        p Visualiza los problemas que pueden tener los clientes y trata de resolverlos de forma preventiva, se centra en detectar los problemas desde el principio, evitando que aumenten el tamaño y se vuelvan graves.
      .col-lg-4.col-sm-8.mb-lg-0.mb-4(data-aos="flip-up")
        figure.mb-4
          img(src='@/assets/curso/img21.svg', style="width: 450px; margin: auto;" alt="Imagen decorativa")
        .h5 Atención al cliente
        p Se centra en resolver los problemas que los clientes han identificado, la clave de la asistencia es proporcionar los medios y los métodos para solucionar el problema o la preocupación en cuestión.
      .col-lg-4.col-sm-8(data-aos="fade-left")
        figure.mb-4
          img(src='@/assets/curso/img22.svg', style="width: 450px; margin: auto;" alt="Imagen decorativa")
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-4.mb-lg-0.mb-4(data-aos="fade-right")
        figure
          img(src='@/assets/curso/img24.svg', style="width: 360px; margin: auto;" alt="Imagen decorativa")
    ...
    .tarjeta.color-acento-botones2.p-4.p-md-5.mb-5(data-aos="flip-up")
      .row.justify-content-around.align-items-center
        ...
        .col-lg-6.col-md
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              h4.mb-1 Implementación de políticas de atención al cliente
              p.mb-0 Cada empresa tiene características específicas y su propio modelo de negocios, por lo cual no es posible hablar de un modelo único, no obstante, se proponen las siguientes pautas básicas para la redacción de este importante documento.
            .col-sm-auto
              a.boton.color-acento-contenido(:href="obtenerLink('downloads/Implementacion_de_politicas_de_atencion_al_cliente.pdf')" target="_blank" type="application/pdf")
                span Descargar
    ...
    .row.justify-content-center.align-items-center
      .col-lg-4.col-8.mb-lg-0.mb-4(data-aos="fade-right")
        figure
          img(src='@/assets/curso/img26.svg', style="width: 360px; margin: auto;" alt="Imagen decorativa")
    ...
    .row.align-items-center.mb-4
      .col-lg-6.order-lg-1.order-2(data-aos="fade-right")
        .cajon.color-primario.p-4.mb-4
          p.mb-0 Lograr que un cliente sea fiel a la empresa, consiste en lograr que vuelva a comprar en la misma y no a la competencia, lo cual se logra a través de la diferenciación, esto sucede cuando se le da algo más de lo que el cliente espera, algo más que la satisfacción básica de la necesidad específica, cuando encuentra en la empresa algo que la competencia no le ofrece. Estamos hablando de hacerlo fiel a nosotros y ello se logra mediante el servicio, es decir, mediante el impacto positivo que logramos que viva y sienta el cliente en cada contacto que tiene con la empresa.
        p.mb-0 Aclarando que, para considerar una relación duradera con los clientes, hay que identificar las necesidades y las preferencias están en constante evolución, y se debe realizar el rediseño constante de los productos y del negocio como tal.
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-primario.p-5(data-aos="fade-right")
        .row.justify-content-center.mb-4
          .col-6
            figure
              img(src='@/assets/curso/img28.svg', alt="Imagen decorativa")
        .h2.text-center Cualitativamente
        p.mb-0 Es importante porque la pérdida de clientes afecta la imagen de la empresa, un cliente insatisfecho no sólo no volverá, sino que también trasladará su mala experiencia a otros potenciales clientes y ello puede generar una pirámide inversa con resultados nocivos para el prestigio de la empresa.
      .col-md.tarjeta.color-acento-botones.p-5(data-aos="fade-left")
        .row.justify-content-center.mb-4
          .col-6
            figure
              img(src='@/assets/curso/img29.svg', alt="Imagen decorativa")
        .h2.text-center Cuantitativamente
        p.mb-0 Se ha demostrado el alto costo que implica conseguir nuevos clientes. Se estima que conseguir un cliente nuevo conlleva diez veces el costo de conservar un cliente.
    ...
    .row.justify-content-center.mb-5
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-right")
        .tarjeta-numerada.color-primario.p-5
          ...
          p.text-center 
            b Accesibilidad
          p.text-center Las organizaciones deben facilitar que los clientes contacten con ellas y puedan recibir la información que desean.
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-left")
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 2
          p.text-center 
            b Capacidad de respuesta
          p.text-center Se entiende por tal la disposición de atender y dar un servicio rápido. El cliente es cada vez más exigente en este sentido.
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-right")
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 3
          ...
          p.text-center Se sobreentiende que las organizaciones orientadas al consumidor deben esforzarse por atenderlos, teniéndolos permanentemente en su mercado objetivo. Esto supone detectar necesidades y disponer de todos los medios para tratar de satisfacerlos.
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-left")
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 4
          p.text-center 
            b Comunicación
          p.text-center Las organizaciones deben escuchar a sus clientes e informarles en un lenguaje comprensible.
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-right")
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 5
          p.text-center 
            b Cortesía
          p.text-center Se resume en la capacidad de prestar atención, consideración, respeto y amabilidad en el trato con los clientes.
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-left")
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 6
          p.text-center 
            b Credibilidad
          p.text-center Los proveedores deben proporcionar imagen de veracidad y honestidad.
      .col-md-6.col-sm-8.mb-4.d-flex(data-aos="fade-right")
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 7
    ...
    .row.justify-content-center.mb-5
      .col-10
        .row.justify-content-center
          .col-lg-4.col-sm-6.mb-4.d-flex(data-aos="fade-right")
            .tarjeta--boton.color-primario.p-4
              .row.justify-content-center.mb-3
                .col-7
                  figure
                    img(src='@/assets/curso/img31.svg', alt="Imagen decorativa")
              .h3.text-center.mb-0 Rastrea activamente y administra la información de los clientes.
          .col-lg-4.col-sm-6.mb-4.d-flex(data-aos="flip-up")
            .tarjeta--boton.color-primario.p-4
              .row.justify-content-center.mb-3
                .col-7
                  figure
                    img(src='@/assets/curso/img32.svg', alt="Imagen decorativa")
              .h3.text-center.mb-0 Conecta todo su equipo en cualquier dispositivo.
          .col-lg-4.col-sm-6.mb-4.d-flex(data-aos="fade-left")
            .tarjeta--boton.color-primario.p-4
              .row.justify-content-center.mb-3
                .col-7
                  figure
                    img(src='@/assets/curso/img33.svg', alt="Imagen decorativa")
              .h3.text-center.mb-0 Captura de manera inteligente los e-mails de los clientes.
          .col-lg-4.col-sm-6.mb-lg-0.mb-4.d-flex(data-aos="fade-right")
            .tarjeta--boton.color-primario.p-4
              .row.justify-content-center.mb-3
                .col-7
                  figure
          ...
          .col-lg-4.col-sm-6.d-flex(data-aos="fade-left")
            .tarjeta--boton.color-primario.p-4
              .row.justify-content-center.mb-3
                .col-7
                  figure
                    img(src='@/assets/curso/img36.svg', alt="Imagen decorativa")
              .h3.text-center.mb-0 Expande y personaliza conforme el crecimiento de su empresa.
    ...
    .row.justify-content-center.mb-4
      .col-10(data-aos="flip-up")
        .cajon1.color-primario1.p-4
          p.mb-0 El concepto de servucción está relacionado con la visión específica de la gestión de la empresa u organización proveedora de servicios. La visión se basa en la gestión del modelo de gestión de aplicaciones, que equipara la “producción” con la fabricación de productos y el “servicio” con la fabricación de servicios.
    
    .row.align-items-center.mb-4
      .col-lg-5.col-10.mb-lg-0.mb-4(data-aos="fade-right")
        figure
          img(src='@/assets/curso/img37.svg', style="width: 600px; margin: auto;" alt="Imagen decorativa")
