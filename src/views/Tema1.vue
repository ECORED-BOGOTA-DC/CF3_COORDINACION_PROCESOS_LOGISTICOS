    ...
    TabsB.color-acento-contenido.mb-5(data-aos="zoom-in")
      .py-4.py-md-5(titulo="Definición" :icono="require('@/assets/curso/img1.svg')" alt="Imagen decorativa")
        .row.justify-content-center.align-items-center
          .col-lg-6.order-lg-1.order-2
            ...
            p.mb-0 Entonces la definición de cliente queda abierta para toda aquella persona que compra, adquiere o usa los productos o servicios de una empresa, inclusive si no llega a ser el consumidor final.
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/img5.svg', style="width: 450px; margin: auto;")
      .py-4.py-md-5(titulo="Piense" :icono="require('@/assets/curso/img2.svg')" alt="Imagen decorativa")
        .row.justify-content-center.align-items-center
          .col-lg-6.order-lg-1.order-2
            figure
              img(src='@/assets/curso/img6.svg', style="width: 450px; margin: auto;")
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
      ...
      .py-4.py-md-5(titulo="Principios para definir un cliente" :icono="require('@/assets/curso/img3.svg')" alt="Imagen decorativa")
        .row.justify-content-center.align-items-start
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/img7.svg', style="width: 400px; margin: auto;" alt="Imagen decorativa")
      .py-4.py-md-5(titulo="Tipos de clientes" :icono="require('@/assets/curso/img4.svg')")
        .row.justify-content-center.align-items-center
          .col-lg-6.order-lg-1.order-2
            figure
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            ...
            a.anexo.mb-4(:href="obtenerLink('downloads/Tipos_de_clientes_segun_su_nivel_de_fidelizacion.pdf')" target="_blank")
              ...
              .anexo__texto
                p.mb-0 #[b Anexo.] Tipos de clientes
    
    .row.justify-content-center.mb-5
      .col-lg-10(data-aos="flip-up")
        .cajon.color-primario.p-4.mb-4
          p.mb-0 Por el lado del proveedor se recomienda tener en cuenta lo siguiente:
    
    TabsB.color-acento-contenido.mb-5(data-aos="zoom-in")
      .py-4.py-md-5(titulo="Tipos de proveedores" :icono="require('@/assets/curso/img9.svg')")
        .row.justify-content-center.align-items-center
          .col-lg-4.col-8.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/img13.svg', style="width: 350px; margin: auto;" alt="Imagen decorativa")
          .col-lg-8
            p Los tipos de proveedores dependen mucho del tipo de empresa, pero por lo general son los siguientes dos tipos:
            p #[b Proveedor de bienes:] empresa o persona que se dedica a la elaboración de algún producto, lo cual tiene un coste económico en el mercado. Los proveedores de bienes tienen como característica principal satisfacer una necesidad real del mercado.
            p.mb-0 #[b Proveedor de servicios:] empresa o persona, cuya actividad busca responder las necesidades del cliente, que por su característica principal de servicio es intangible, es decir, que no se puede tocar, pero ese servicio está apoyado por bienes tangibles para lograr dicha actividad.
      .py-4.py-md-5(titulo="Selección de proveedores" :icono="require('@/assets/curso/img10.svg')")
        .row.justify-content-center.align-items-center
          .col-lg-6.order-lg-1.order-2
      ...
      .py-4.py-md-5(titulo="Recuerde" :icono="require('@/assets/curso/img11.svg')")
        .row.justify-content-center.align-items-center
          .col-lg-4.col-8.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/img14.svg', style="width: 350px; margin: auto;" alt="Imagen decorativa")
          .col-lg-8
            ul.lista-ul--color
              li 
                i.fas.fa-atom
